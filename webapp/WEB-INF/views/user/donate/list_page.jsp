...
<script type="text/javascript" src="<%=request.getContextPath() %>/resources/js/donate/list_page.js"></script>
<!-- bootstrap -->
			...
			<div class="col">
				...
				<div class="text-center my-4">
					...
					<c:forEach items="${categoryList }" var="category">
						<button class="btn btn-outline-secondary" style="width: 130px;" onclick="searchCategory(${category.mst_dc_no })">${category.mst_dc_category }</button>
					</c:forEach>
				</div>
				<div class="row mt-4">
					<div class="col-2">
					...
					<div class="col-2"><!-- 펀딩 개설 -->
						<c:if test="${loginUser.memberVo.mst_mt_no == 3 }">
							<a href="./create_page.do" class="form-control btn btn-outline-primary">기부 개설</a>
						</c:if>
					</div>
				</div>
				<!-- 기부 리스트 표시 영역 -->
