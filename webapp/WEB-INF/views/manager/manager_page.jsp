		...
		<div class="row">
			<div class="col">
				<div class="row row-cols-1 row-cols-md-4 g-4 mt-4">
				  <div class="col">
				    <div class="card h-100 bg-primary" onclick="location.href='../donate/list_page.do'" style="cursor: pointer;">
				      <div class="card-body">
					    ...
					    <div class="card h-100 bg-light" onclick="location.href='../donate/read_page.do?mst_d_no=${donate.mstDonateVo.mst_d_no }'" style="cursor: pointer;">
					      ...
					      <div class="card-body">
					        ...
					        <p class="card-text">
					        	...
					        	<div class="progress">
										  <div class="progress-bar" role="progressbar" style="width: ${donate.percent }%" aria-valuenow="${donate.percent }" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="row">
				...
				<div class="row row-cols-1 row-cols-md-4 g-4 mt-4">  
				 <div class="col">
				    <div class="card h-100 bg-success" onclick="location.href='../volunteer/list_page.do'" style="cursor: pointer;">
				      <div class="card-body">
				...
				<div class="row row-cols-1 row-cols-md-4 g-4 mt-4">
				  <div class="col">
				    <div class="card h-100 bg-info" onclick="location.href='../funding/list_page.do'" style="cursor: pointer;">
				      <div class="card-body">
