...
<body>
	<jsp:include page="/WEB-INF/views/manager/commons/global_nav.jsp" />
		...
		<div class="container min-height mb-5" role="main">
			<div class="row">
				...
				<div class="col-10 mt-3">
					<h2>자유롭게 글을 남겨보세요!</h2>
					<form id="form" action="${pageContext.request.contextPath}/manager/update_notice_process.do" method="post">
						<div class="row mt-3">
							<div class="col">
								<label for="title"></label>
								<input type="text" class="form-control" name="bn_title" id="title" placeholder="제목을 입력하세요" value="${result.noticeVo.bn_title }">
						...
						<div class="mt-3">
							...
							<textarea class="form-control min-height" rows="9" name="bn_content" id="content" placeholder="내용을 입력하세요">${result.noticeVo.bn_content }</textarea>
							<input type="hidden" name="bn_no" value="${result.noticeVo.bn_no }">
